...
class HubConnection {
  ...
  Function(String target, List<Object?>?)? _defaultMethodOnError;
  ...
  static HubConnection create(
      ...
      Function(String target, List<Object?>?)? defaultMethodOnError}) {
    return HubConnection(connection, logger, protocol,
        reconnectPolicy: reconnectPolicy,
        defaultMethodOnError: defaultMethodOnError);
  }
  ...
  HubConnection(IConnection connection, Logger? logger, IHubProtocol protocol,
    ...
    _defaultMethodOnError = defaultMethodOnError;
  ...
  void _invokeClientMethod(InvocationMessage invocationMessage) {
    ...
    if (methods != null) {
      ...
      _defaultMethod(invocationMessage);
      _logger?.warning(
          "No client method with the name '${invocationMessage.target}' found. calling to default");
    }
  }

  _defaultMethod(InvocationMessage invocationMessage) {
    if (_defaultMethodOnError != null)
      _defaultMethodOnError!(
          invocationMessage.target ?? 'no_target', invocationMessage.arguments);
  }
